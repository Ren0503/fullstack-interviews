...
React là một thư viện JavaScript mã nguồn mở linh động và hiệu quả cho phép các dev tạo các ứng dụng web đơn giản, nhanh chóng và có thể mở rộng. Jordan Walke, kỹ sư phần mềm đang làm việc Facebook đã tạo React. Nó được triển khai đầu tiên trên newsfeed của Facebook vào năm 2011 và Instagram 2012. 
